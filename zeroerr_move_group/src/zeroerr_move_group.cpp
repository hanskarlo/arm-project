...
static const rclcpp::Logger LOGGER = rclcpp::get_logger("zeroerr_move_group");
...
int main(int argc, char** argv)
{
  ...
  auto move_group_node = rclcpp::Node::make_shared("zeroerr_move_group", node_options);
  ...
  moveit_visual_tools::MoveItVisualTools visual_tools(move_group_node, "base_link", "marker_topic",
  ...
  visual_tools.publishText(text_pose, "ZeroErr Move Group Interface", rvt::WHITE, rvt::LARGE);
  ...
  target_pose1.orientation.x = 0.49981;
  target_pose1.orientation.y = -0.50018;
  target_pose1.orientation.z = 0.500;
  target_pose1.orientation.w = 0.5002017617225647;
  target_pose1.position.x = 0.499814;
  target_pose1.position.y = -0.499788;
  target_pose1.position.z = -0.500178;
